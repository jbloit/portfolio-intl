      ...
      <div className="plain">
        <div className="about">
         ...
         <div className="skills">
            ...
            <div className="domain">Digital instruments / sound design </div> <div className="skillset">Max/MSP, SuperCollider, Ableton Live, Reaper, Audacity, Bela, audio on RaspberryPi, Jack</div>
