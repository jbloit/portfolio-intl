      ...
      <div className="plain">
        ...
        <p>Particulièrement sensible aux applications pédagogiques, j'anime un <a href="https://www.spoken.brussels/robotics" target="_blank" rel="noopener noreferrer">atelier hebdomadaire de robotique pour enfants.</a></p>
         ...
         <div className="skills">
            ...
            <div className="domain">Musique</div> <div className="skillset">Batteur +30ans d'expérience, Harmonie 4 voies.</div>
         </div>
